			...
			<div class="site-info">
				<div class="footer-text">
					...
					if ('' != $footer_text) {
						...
						<a href="http://wordpress.org/" title="<?php esc_attr_e( 'A Semantic Personal Publishing Platform', 'duena' ); ?>" rel="generator"><?php printf( __( 'Propulser par %s', 'duena' ), 'WordPress' ); ?></a>
					<?php } ?>
				</div>
